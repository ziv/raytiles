...
RaytilesStreamer* RaytilesStreamerCreateLatLon(double latitude, double longitude, const RaytilesConfig* config);
...
bool RaytilesStreamerGroundHeight(const RaytilesStreamer* streamer, Vector3 position, float* out_height);
