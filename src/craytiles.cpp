...
struct RaytilesStreamer {
  ...
  explicit RaytilesStreamer(raytiles::config cfg) : impl(std::move(cfg)) {}

  RaytilesStreamer(const double latitude, const double longitude, raytiles::config cfg) : impl(latitude, longitude, std::move(cfg)) {}
};
